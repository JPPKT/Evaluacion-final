package com.example.firebasedeprueba;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void CrearMensaje(View view){
        ...
        contador++;
        reference.child("mensaje").child(usuario.getUid()).child("mensaje_"+contador).child("titulo").setValue(titulo.getText().toString());
        reference.child("mensaje").child(usuario.getUid()).child("mensaje_"+contador).child("mensaje").setValue(mensaje.getText().toString());
       ...
       // reference.child("mensajes").child(usuario.getUid()).child("mensaje_"+contador).child("idSecreto").setValue(claveUnica);
        ...
        Toast.makeText(this, "Mensaje creado on id: "+contador, Toast.LENGTH_LONG).show();
        titulo.setText("");
        mensaje.setText("");
